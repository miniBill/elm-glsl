module Glsl.Functions exposing
    ...
    , absd3, absd4, absi1, absi2, absi3, absi4
    , ceil1, ceil2, ceil3, ceil4, ceild1, ceild2
    , ceild3, ceild4, ceil
    , clamp111, clamp211, clamp222, clamp311, clamp333, clamp411
    , clamp444, clampd1d1d1, clampd2d1d1, clampd2d2d2, clampd3d1d1, clampd3d3d3
    , clampd4d1d1, clampd4d4d4, clampi1i1i1, clampi2i1i1, clampi2i2i2, clampi3i1i1
    , clampi3i3i3, clampi4i1i1, clampi4i4i4, clampu1u1u1, clampu2u1u1, clampu2u2u2
    , clampu3u1u1, clampu3u3u3, clampu4u1u1, clampu4u4u4
    , cross33, crossd3d3
    , distance11, distance22, distance33, distance44, distanced1d1, distanced2d2
    , distanced3d3, distanced4d4, distance
    , dot11, dot22, dot33, dot44, dotd1d1, dotd2d2
    , dotd3d3, dotd4d4, dot
    , faceforward111, faceforward222, faceforward333, faceforward444, faceforwardd1d1d1, faceforwardd2d2d2
    , faceforwardd3d3d3, faceforwardd4d4d4, faceforward
    ...
    , floord3, floord4
    , fma111, fma222, fma333, fma444, fmad1d1d1, fmad2d2d2
    , fmad3d3d3, fmad4d4d4, fma
    , fract1, fract2, fract3, fract4, fractd1, fractd2
    , fractd3, fractd4, fract
    , frexp1oi1, frexp2oi2, frexp3oi3, frexp4oi4, frexpd1oi1, frexpd2oi2
    , frexpd3oi3, frexpd4oi4
    , int1
    ...
    , inversesqrtd3, inversesqrtd4, inversesqrt
    ...
    , ivec3i1i1i1
    , ivec4i1i1i1i1
    , ldexp1i1, ldexp2i2, ldexp3i3, ldexp4i4, ldexpd1i1, ldexpd2i2
    , ldexpd3i3, ldexpd4i4
    , length1, length2, length3, length4, lengthd1, lengthd2
    , lengthd3, lengthd4, length
    , mat21111, mat222
    , mat3111111111, mat3333
    , mat44444
    , max11, max21, max22, max31, max33, max41
    , max44, maxd1d1, maxd2d1, maxd2d2, maxd3d1, maxd3d3
    , maxd4d1, maxd4d4, maxi1i1, maxi2i1, maxi2i2, maxi3i1
    , maxi3i3, maxi4i1, maxi4i4, maxu1u1, maxu2u1, maxu2u2
    , maxu3u1, maxu3u3, maxu4u1, maxu4u4
    , min11, min21, min22, min31, min33, min41
    , min44, mind1d1, mind2d1, mind2d2, mind3d1, mind3d3
    , mind4d1, mind4d4, mini1i1, mini2i1, mini2i2, mini3i1
    , mini3i3, mini4i1, mini4i4, minu1u1, minu2u1, minu2u2
    , minu3u1, minu3u3, minu4u1, minu4u4
    , mix111, mix221, mix222, mix331, mix333, mix441
    , mix444, mixd1d1d1, mixd2d2d1, mixd2d2d2, mixd3d3d1, mixd3d3d3
    , mixd4d4d1, mixd4d4d4, mix
    , mod11, mod21, mod22, mod31, mod33, mod41
    , mod44, modd1d1, modd2d1, modd2d2, modd3d1, modd3d3
    , modd4d1, modd4d4, mod
    , modf1o1, modf2o2, modf3o3, modf4o4, modfd1od1, modfd2od2
    , modfd3od3, modfd4od4, modf
    , normalize1, normalize2, normalize3, normalize4, normalized1, normalized2
    , normalized3, normalized4, normalize
    , reflect11, reflect22, reflect33, reflect44, reflectd1d1, reflectd2d2
    , reflectd3d3, reflectd4d4, reflect
    , refract111, refract221, refract331, refract441, refractd1d11, refractd2d21
    , refractd3d31, refractd4d41, refract
    , round1, round2, round3, round4, roundd1, roundd2
    , roundd3, roundd4
    , roundEven1, roundEven2, roundEven3, roundEven4, roundEvend1, roundEvend2
    , roundEvend3, roundEvend4, roundEven
    , sign1, sign2, sign3, sign4, signd1, signd2
    , signd3, signd4, signi1, signi2, signi3, signi4
    , sign
    , smoothstep111, smoothstep112, smoothstep113, smoothstep114, smoothstep222, smoothstep333
    , smoothstep444, smoothstepd1d1d1, smoothstepd1d1d2, smoothstepd1d1d3, smoothstepd1d1d4, smoothstepd2d2d2
    , smoothstepd3d3d3, smoothstepd4d4d4, smoothstep
    , sqrt1, sqrt2, sqrt3, sqrt4, sqrtd1, sqrtd2
    , sqrtd3, sqrtd4
    , step11, step12, step13, step14, step22, step33
    , step44, stepd1d1, stepd1d2, stepd1d3, stepd1d4, stepd2d2
    , stepd3d3, stepd4d4, step
    , trunc1, trunc2, trunc3, trunc4, truncd1, truncd2
    , truncd3, truncd4, trunc
    , uintBitsToFloatu1, uintBitsToFloatu2, uintBitsToFloatu3, uintBitsToFloatu4
    , vec21, vec211, vec21i1, vec2i1, vec2i11, vec2i1i1
    , vec31, vec3111, vec311i1, vec312, vec31i11, vec31i1i1
    , vec321, vec3i1, vec3i111, vec3i11i1, vec3i1i11, vec3i1i1i1
    , vec41, vec41111, vec4111i1, vec411i11, vec411i1i1, vec413
    , vec41i111, vec41i11i1, vec41i1i11, vec41i1i1i1, vec422, vec431
    , vec4i1, vec4i1111, vec4i111i1, vec4i11i11, vec4i11i1i1, vec4i1i111
...
@docs absd3, absd4, absi1, absi2, absi3, absi4


## ceil

@docs ceil1, ceil2, ceil3, ceil4, ceild1, ceild2
@docs ceild3, ceild4, ceil


## clamp

@docs clamp111, clamp211, clamp222, clamp311, clamp333, clamp411
@docs clamp444, clampd1d1d1, clampd2d1d1, clampd2d2d2, clampd3d1d1, clampd3d3d3
@docs clampd4d1d1, clampd4d4d4, clampi1i1i1, clampi2i1i1, clampi2i2i2, clampi3i1i1
@docs clampi3i3i3, clampi4i1i1, clampi4i4i4, clampu1u1u1, clampu2u1u1, clampu2u2u2
@docs clampu3u1u1, clampu3u3u3, clampu4u1u1, clampu4u4u4
...
@docs distance11, distance22, distance33, distance44, distanced1d1, distanced2d2
@docs distanced3d3, distanced4d4, distance


## dot

@docs dot11, dot22, dot33, dot44, dotd1d1, dotd2d2
@docs dotd3d3, dotd4d4, dot


## faceforward

@docs faceforward111, faceforward222, faceforward333, faceforward444, faceforwardd1d1d1, faceforwardd2d2d2
@docs faceforwardd3d3d3, faceforwardd4d4d4, faceforward
...
@docs floord3, floord4


## fma

@docs fma111, fma222, fma333, fma444, fmad1d1d1, fmad2d2d2
@docs fmad3d3d3, fmad4d4d4, fma


## fract

@docs fract1, fract2, fract3, fract4, fractd1, fractd2
@docs fractd3, fractd4, fract


## frexp

@docs frexp1oi1, frexp2oi2, frexp3oi3, frexp4oi4, frexpd1oi1, frexpd2oi2
@docs frexpd3oi3, frexpd4oi4
...
@docs ldexp1i1, ldexp2i2, ldexp3i3, ldexp4i4, ldexpd1i1, ldexpd2i2
@docs ldexpd3i3, ldexpd4i4


## length

@docs length1, length2, length3, length4, lengthd1, lengthd2
@docs lengthd3, lengthd4, length


## mat2

@docs mat21111, mat222


## mat3

@docs mat3111111111, mat3333
...
@docs max11, max21, max22, max31, max33, max41
@docs max44, maxd1d1, maxd2d1, maxd2d2, maxd3d1, maxd3d3
@docs maxd4d1, maxd4d4, maxi1i1, maxi2i1, maxi2i2, maxi3i1
@docs maxi3i3, maxi4i1, maxi4i4, maxu1u1, maxu2u1, maxu2u2
@docs maxu3u1, maxu3u3, maxu4u1, maxu4u4


## min

@docs min11, min21, min22, min31, min33, min41
@docs min44, mind1d1, mind2d1, mind2d2, mind3d1, mind3d3
@docs mind4d1, mind4d4, mini1i1, mini2i1, mini2i2, mini3i1
@docs mini3i3, mini4i1, mini4i4, minu1u1, minu2u1, minu2u2
@docs minu3u1, minu3u3, minu4u1, minu4u4


## mix

@docs mix111, mix221, mix222, mix331, mix333, mix441
@docs mix444, mixd1d1d1, mixd2d2d1, mixd2d2d2, mixd3d3d1, mixd3d3d3
@docs mixd4d4d1, mixd4d4d4, mix


## mod

@docs mod11, mod21, mod22, mod31, mod33, mod41
@docs mod44, modd1d1, modd2d1, modd2d2, modd3d1, modd3d3
@docs modd4d1, modd4d4, mod


## modf

@docs modf1o1, modf2o2, modf3o3, modf4o4, modfd1od1, modfd2od2
@docs modfd3od3, modfd4od4, modf


## normalize

@docs normalize1, normalize2, normalize3, normalize4, normalized1, normalized2
@docs normalized3, normalized4, normalize


## reflect

@docs reflect11, reflect22, reflect33, reflect44, reflectd1d1, reflectd2d2
@docs reflectd3d3, reflectd4d4, reflect


## refract

@docs refract111, refract221, refract331, refract441, refractd1d11, refractd2d21
@docs refractd3d31, refractd4d41, refract


## round

@docs round1, round2, round3, round4, roundd1, roundd2
@docs roundd3, roundd4


## roundEven

@docs roundEven1, roundEven2, roundEven3, roundEven4, roundEvend1, roundEvend2
@docs roundEvend3, roundEvend4, roundEven


## sign

@docs sign1, sign2, sign3, sign4, signd1, signd2
@docs signd3, signd4, signi1, signi2, signi3, signi4
@docs sign


## smoothstep

@docs smoothstep111, smoothstep112, smoothstep113, smoothstep114, smoothstep222, smoothstep333
@docs smoothstep444, smoothstepd1d1d1, smoothstepd1d1d2, smoothstepd1d1d3, smoothstepd1d1d4, smoothstepd2d2d2
@docs smoothstepd3d3d3, smoothstepd4d4d4, smoothstep
...
@docs step11, step12, step13, step14, step22, step33
@docs step44, stepd1d1, stepd1d2, stepd1d3, stepd1d4, stepd2d2
@docs stepd3d3, stepd4d4, step


## trunc

@docs trunc1, trunc2, trunc3, trunc4, truncd1, truncd2
@docs truncd3, truncd4, trunc
...
@docs vec31, vec3111, vec311i1, vec312, vec31i11, vec31i1i1
@docs vec321, vec3i1, vec3i111, vec3i11i1, vec3i1i11, vec3i1i1i1


## vec4

@docs vec41, vec41111, vec4111i1, vec411i11, vec411i1i1, vec413
@docs vec41i111, vec41i11i1, vec41i1i11, vec41i1i1i1, vec422, vec431
@docs vec4i1, vec4i1111, vec4i111i1, vec4i11i11, vec4i11i1i1, vec4i1i111
@docs vec4i1i11i1, vec4i1i1i11, vec4i1i1i1i1

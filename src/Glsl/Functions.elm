module Glsl.Functions exposing (abs1, abs2, abs3, abs4, acos1, acos2, acos3, acos4, asin1, asin2, asin3, asin4, atan1, atan11, atan2, atan22, atan3, atan33, atan4, atan44, ceil1, ceil2, ceil3, ceil4, clamp111, clamp211, clamp222, clamp311, clamp333, clamp411, clamp444, cos1, cos2, cos3, cos4, cross33, degrees1, degrees2, degrees3, degrees4, distance11, distance22, distance33, distance44, dot11, dot22, dot33, dot44, exp1, exp2, exp21, exp22, exp23, exp24, exp3, exp4, faceforward111, faceforward222, faceforward333, faceforward444, floati1, floor1, floor2, floor3, floor4, fract1, fract2, fract3, fract4, fwidth1, fwidth2, fwidth3, fwidth4, int1, inversesqrt1, inversesqrt2, inversesqrt3, inversesqrt4, ivec2i1i1, ivec3i1i1i1, ivec4i1i1i1i1, length1, length2, length3, length4, log1, log2, log21, log22, log23, log24, log3, log4, mat3333, max11, max21, max22, max31, max33, max41, max44, min11, min21, min22, min31, min33, min41, min44, mix111, mix221, mix222, mix331, mix333, mix441, mix444, mod11, mod21, mod22, mod31, mod33, mod41, mod44, normalize1, normalize2, normalize3, normalize4, pow11, pow22, pow33, pow44, radians1, radians2, radians3, radians4, reflect11, reflect22, reflect33, reflect44, refract111, refract221, refract331, refract441, sign1, sign2, sign3, sign4, sin1, sin2, sin3, sin4, smoothstep111, smoothstep112, smoothstep113, smoothstep114, smoothstep222, smoothstep333, smoothstep444, sqrt1, sqrt2, sqrt3, sqrt4, step11, step12, step13, step14, step22, step33, step44, tan1, tan2, tan3, tan4, vec21, vec211, vec21i1, vec2i1, vec2i11, vec2i1i1, vec31, vec3111, vec311i1, vec31i11, vec31i1i1, vec3i1, vec3i111, vec3i11i1, vec3i1i11, vec3i1i1i1, vec41, vec41111, vec4111i1, vec411i11, vec411i1i1, vec413, vec41i111, vec41i11i1, vec41i1i11, vec41i1i1i1, vec431, vec4i1, vec4i1111, vec4i111i1, vec4i11i11, vec4i11i1i1, vec4i1i111, vec4i1i11i1, vec4i1i1i11, vec4i1i1i1i1)

{-| 
## abs

@docs abs1, abs2, abs3, abs4
...
distance11 :
    Glsl.Expression Float -> Glsl.Expression Float -> Glsl.Expression Float
distance11 a b =
...
ivec2i1i1 :
    Glsl.Expression Int -> Glsl.Expression Int -> Glsl.Expression Glsl.Vec2
ivec2i1i1 a b =
...
vec211 :
    Glsl.Expression Float -> Glsl.Expression Float -> Glsl.Expression Glsl.Vec2
vec211 a b =
    Glsl.unsafeCall2 "vec2" [] a b


vec21i1 :
    Glsl.Expression Float -> Glsl.Expression Int -> Glsl.Expression Glsl.Vec2
vec21i1 a b =
    Glsl.unsafeCall2 "vec2" [] a b
...
vec2i11 :
    Glsl.Expression Int -> Glsl.Expression Float -> Glsl.Expression Glsl.Vec2
vec2i11 a b =
    Glsl.unsafeCall2 "vec2" [] a b
